...
// ══════════════════════════════════════════════════════════════════
    ...
    const _agentCls = { samantha:'text-teal-400', scout:'text-green-400', main:'text-indigo-400', cliff:'text-indigo-400', 'claude-code':'text-purple-400', atlas:'text-orange-400', fernanda:'text-emerald-400', cora:'text-cyan-400', kendall:'text-violet-400' };
    const _agentLabel = { main:'Cliff', cliff:'Cliff', samantha:'Samantha', scout:'Scout', atlas:'Atlas', fernanda:'Fernanda', cora:'Cora', kendall:'Kendall', 'claude-code':'Claude Code' };
    ...
    if (typeof CRON_DISPLAY === 'object') {
      ...
      CRON_DISPLAY['kendall-heartbeat'] = 'Heartbeat';
    }
    ...
    const _taskTooltips = {
      ...
      'Richelle (Telegram DM)':     'Telegram conversation between Richelle Peters and Kendall — health research and alternative medicine guidance.',
      'Kendall (Subagent Run)':     'Kendall spawned a short-lived helper session for an isolated task.',
    ...
    function _populateTaskDropdown(taskNames) {
      ...
      const agentLabels = { cliff: 'Cliff', samantha: 'Samantha', scout: 'Scout', atlas: 'Atlas', fernanda: 'Fernanda', cora: 'Cora', kendall: 'Kendall', 'claude-code': 'Claude Code' };
